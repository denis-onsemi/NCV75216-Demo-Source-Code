...
public:
    ...
    /* field description by fieldname */
    bool field(QString *pbit_name,QString *pbit_description, const QByteArray &fieldname);
    /* bits count*/
    ...
    */
    ...
    typedef enum {CRC8_LSB,CRC8_MSB,CRC16} Crc;
    quint32 crc(Crc crc_method, quint32 init, quint32 poly, qint32 from, qint32 to=-1);
