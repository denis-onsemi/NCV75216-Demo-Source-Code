...
const char* BitFieldParser::name()
{
    return field(NAME);
}
bool BitFieldParser::rangeIsName() const
{
    return bit_by_name;
}

const char* BitFieldParser::range_name()
{
    return field(RANGEA);
}
qint32 BitFieldParser::value() const
{
    return m_value;
}
const char*  BitFieldParser::description()
{
    return field(DESCR);
}

const bool BitFieldParser::hasDoubleRange()const
{
    return has_double_range;
}

qint32 BitFieldParser::lsb() const
{
    return m_range_lsb;
}
qint32 BitFieldParser::msb() const
{
    return m_range_msb;
}
bool BitFieldParser::isOk() const
{
    return m_ok;
}
